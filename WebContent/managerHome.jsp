...
<div class="w3-container w3-content" style="max-width:800px;margin-top:100px">    
  ...
  <div class="w3-row">
    <!-- Left Column -->
      ...
      <div class="w3-card-2 w3-round">
        <div class="w3-white">
        <a href="addCourse.jsp" style="text-decoration:none"><button  class="w3-button w3-block w3-theme-l1 w3-left-align"><i class="fa fa-circle-o-notch fa-fw w3-margin-right"></i>Add Course</button></a>
        <a href="selectCourse.jsp" style="text-decoration:none"><button  class="w3-button w3-block w3-theme-l1 w3-left-align"><i class="fa fa-circle-o-notch fa-fw w3-margin-right"></i>Edit Course</button></a>
        <a href="deleteCourse.jsp" style="text-decoration:none"><button  class="w3-button w3-block w3-theme-l1 w3-left-align"><i class="fa fa-circle-o-notch fa-fw w3-margin-right"></i>Delete Course</button></a>
        <a href="selectCounselor.jsp" style="text-decoration:none"><button  class="w3-button w3-block w3-theme-l1 w3-left-align"><i class="fa fa-circle-o-notch fa-fw w3-margin-right"></i>View/Remove Counselor</button></a>
