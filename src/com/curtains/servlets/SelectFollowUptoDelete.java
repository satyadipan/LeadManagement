...
/**
 * Servlet implementation class SelectFollowUptoDelete
 */
@WebServlet("/selectfollowuptodelete")
public class SelectFollowUptoDelete extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.sendRedirect("deleteFollowUp.jsp");
	}
